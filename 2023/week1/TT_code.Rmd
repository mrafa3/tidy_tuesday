...
subtitle_text <- glue("<span style='color:cornflowerblue;font-face:bold'>Myles</span>, <span style='color:#9e9ac8;font-face:bold'>Hazel</span>, & <span style='color:darkseagreen3;font-face:bold'>Archie's</span> sleep patterns during their first month")
...
tib_summary_text <- tibble(
  x = 0, 
  y = 0.15, 
  label = c("**How to read this (ch)art:** colored<br>segments represent times when<br><span style = 'color:cornflowerblue'>**Myles**</span>, <span style = 'color:#9e9ac8'>**Hazel**</span>, or <span style = 'color:darkseagreen3'>**Archie**</span> slept during<br>their first three months. Each circle <br>represents a single day, with inner<br>circles illustrating newborn days and<br>outer circles illustrating days near<br>90 days since birth.<br><br>Data quality may have suffered due<br>to sleep quality."))
