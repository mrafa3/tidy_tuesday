...
(strength_viz <- passwords %>% 
  ...
  ggplot(.) + 
  geom_jitter(aes(x=strength,
                 y=reorder(category, median_password_strength),
                 color=category),
                 height=.2, width = .5) + 
  ...
  plot_annotation(
    ...
    subtitle = 'Each dot represents a unique password from the Knowledge is Beautiful password database',
